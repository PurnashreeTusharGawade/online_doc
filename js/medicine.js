...
import { getLocalStorage, setLocalStorage } from './medicinescript.js';

const iconQty = document.querySelector('.header__icon--total');
const productContainer = document.querySelector('.medicine');
let currentCart;
...
function displayData(data) {
  data.items.forEach((item, index) => {
    ...
    div.innerHTML = `
          ...
          <h5 class="product__1--price">${item.fields.price} Rs.</h5>
